...
public class RangeFragment_Beijing extends BaseFragment implements MsgComeListener {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_set5:  //n3
                if (et4.getText().toString().isEmpty()) {
                    ToastHelper.shortToast(getContext(), "请输入值");
                    return;
                }
                if (activity.type == 0) {   //
                    activity.blewrite("atmorange_config r_so2flg=n4 r_so2=" + et5.getText().toString().trim() + " m_so2=" + num.getText(), true);
                } else if (activity.type == 1) {  //
                    activity.blewrite("atmorange_config r_no2flg=n4 r_no2=" + et5.getText().toString().trim() + " m_no2=" + num.getText(), true);
                } else if (activity.type == 2) {  //
                    activity.blewrite("atmorange_config r_coflg=n4 r_co=" + et5.getText().toString().trim() + " m_co=" + num.getText(), true);
                } else if (activity.type == 3) {  //
                    activity.blewrite("atmorange_config r_o3flg=n4 r_o3=" + et5.getText().toString().trim() + " m_o3=" + num.getText(), true);
                } else if (activity.type == 4) {  //
                    activity.blewrite("tvocrange_config r_tvocflg=n4 tvocppm=" + et5.getText().toString().trim() + " tvocad=" + num.getText(), true);
                }
                break;

            case R.id.btn_set6:  //n3
                if (et4.getText().toString().isEmpty()) {
                    ToastHelper.shortToast(getContext(), "请输入值");
                    return;
                }
                if (activity.type == 0) {   //
                    activity.blewrite("atmorange_config r_so2flg=n5 r_so2=" + et6.getText().toString().trim() + " m_so2=" + num.getText(), true);
                } else if (activity.type == 1) {  //
                    activity.blewrite("atmorange_config r_no2flg=n5 r_no2=" + et6.getText().toString().trim() + " m_no2=" + num.getText(), true);
                } else if (activity.type == 2) {  //
                    activity.blewrite("atmorange_config r_coflg=n5 r_co=" + et6.getText().toString().trim() + " m_co=" + num.getText(), true);
                } else if (activity.type == 3) {  //
                    activity.blewrite("atmorange_config r_o3flg=n5 r_o3=" + et6.getText().toString().trim() + " m_o3=" + num.getText(), true);
                } else if (activity.type == 4) {  //
                    activity.blewrite("tvocrange_config r_tvocflg=n5 tvocppm=" + et6.getText().toString().trim() + " tvocad=" + num.getText(), true);
                }
                break;

            case R.id.btn_set7:  //n3
                if (et4.getText().toString().isEmpty()) {
                    ToastHelper.shortToast(getContext(), "请输入值");
                    return;
                }
                if (activity.type == 0) {   //
                    activity.blewrite("atmorange_config r_so2flg=n6 r_so2=" + et7.getText().toString().trim() + " m_so2=" + num.getText(), true);
                } else if (activity.type == 1) {  //
                    activity.blewrite("atmorange_config r_no2flg=n6 r_no2=" + et7.getText().toString().trim() + " m_no2=" + num.getText(), true);
                } else if (activity.type == 2) {  //
                    activity.blewrite("atmorange_config r_coflg=n6 r_co=" + et7.getText().toString().trim() + " m_co=" + num.getText(), true);
                } else if (activity.type == 3) {  //
                    activity.blewrite("atmorange_config r_o3flg=n6 r_o3=" + et7.getText().toString().trim() + " m_o3=" + num.getText(), true);
                } else if (activity.type == 4) {  //
                    activity.blewrite("tvocrange_config r_tvocflg=n6 tvocppm=" + et7.getText().toString().trim() + " tvocad=" + num.getText(), true);
                }
                break;

            case R.id.btn_set8:  //n3
                if (et4.getText().toString().isEmpty()) {
                    ToastHelper.shortToast(getContext(), "请输入值");
                    return;
                }
                if (activity.type == 0) {   //
                    activity.blewrite("atmorange_config r_so2flg=n7 r_so2=" + et8.getText().toString().trim() + " m_so2=" + num.getText(), true);
                } else if (activity.type == 1) {  //
                    activity.blewrite("atmorange_config r_no2flg=n7 r_no2=" + et8.getText().toString().trim() + " m_no2=" + num.getText(), true);
                } else if (activity.type == 2) {  //
                    activity.blewrite("atmorange_config r_coflg=n7 r_co=" + et8.getText().toString().trim() + " m_co=" + num.getText(), true);
                } else if (activity.type == 3) {  //
                    activity.blewrite("atmorange_config r_o3flg=n7 r_o3=" + et8.getText().toString().trim() + " m_o3=" + num.getText(), true);
                } else if (activity.type == 4) {  //
                    activity.blewrite("tvocrange_config r_tvocflg=n7 tvocppm=" + et8.getText().toString().trim() + " tvocad=" + num.getText(), true);
                }
                break;

            case R.id.btn_set9:  //n3
                if (et4.getText().toString().isEmpty()) {
                    ToastHelper.shortToast(getContext(), "请输入值");
                    return;
                }
                if (activity.type == 0) {   //
                    activity.blewrite("atmorange_config r_so2flg=n8 r_so2=" + et9.getText().toString().trim() + " m_so2=" + num.getText(), true);
                } else if (activity.type == 1) {  //
                    activity.blewrite("atmorange_config r_no2flg=n8 r_no2=" + et9.getText().toString().trim() + " m_no2=" + num.getText(), true);
                } else if (activity.type == 2) {  //
                    activity.blewrite("atmorange_config r_coflg=n8 r_co=" + et9.getText().toString().trim() + " m_co=" + num.getText(), true);
                } else if (activity.type == 3) {  //
                    activity.blewrite("atmorange_config r_o3flg=n8 r_o3=" + et9.getText().toString().trim() + " m_o3=" + num.getText(), true);
                } else if (activity.type == 4) {  //
                    activity.blewrite("tvocrange_config r_tvocflg=n8 tvocppm=" + et9.getText().toString().trim() + " tvocad=" + num.getText(), true);
                }
                break;

            case R.id.btn_set10:  //n3
                if (et4.getText().toString().isEmpty()) {
                    ToastHelper.shortToast(getContext(), "请输入值");
                    return;
                }
                if (activity.type == 0) {   //
                    activity.blewrite("atmorange_config r_so2flg=n9 r_so2=" + et10.getText().toString().trim() + " m_so2=" + num.getText(), true);
                } else if (activity.type == 1) {  //
                    activity.blewrite("atmorange_config r_no2flg=n9 r_no2=" + et10.getText().toString().trim() + " m_no2=" + num.getText(), true);
                } else if (activity.type == 2) {  //
                    activity.blewrite("atmorange_config r_coflg=n9 r_co=" + et10.getText().toString().trim() + " m_co=" + num.getText(), true);
                } else if (activity.type == 3) {  //
                    activity.blewrite("atmorange_config r_o3flg=n9 r_o3=" + et10.getText().toString().trim() + " m_o3=" + num.getText(), true);
                } else if (activity.type == 4) {  //
                    activity.blewrite("tvocrange_config r_tvocflg=n9 tvocppm=" + et10.getText().toString().trim() + " tvocad=" + num.getText(), true);
                }
                break;
            case R.id.btn_over:
                if (activity.type == 0) {   //
