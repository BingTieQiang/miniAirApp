...
public class SwitchButton extends View implements Checkable {
    ...
    private boolean canTog = false;

    public void setCanTog(boolean canTog) {
        this.canTog = canTog;
    }
    ...
    private void toggle(boolean animate, boolean broadcast) {
        if(!canTog){
            if(onCanNotListener!=null){
                onCanNotListener.onCheckedChanged(canTog);
            }
            return;
        }
        if(!isEnabled()){return;}
    ...
    public interface OnCanNotListener{
        void onCheckedChanged(boolean cando);
    }
    /*******************************************************/
    ...
    public void setOnCanNotListener(OnCanNotListener onCanNotListener) {
        this.onCanNotListener = onCanNotListener;
    }

    private OnCanNotListener onCanNotListener;
